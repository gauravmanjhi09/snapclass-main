...
#     data = {'subject_id': sub_id, 'subject_name': sub_name,'section':sub_section,'teacher_id':teacher_id}
#     response = supabase.table("subjects").insert(data).execute()
#     return response.data

# def create_subject(sub_name, sub_section, teacher_id):
#     data = {'subject_code': sub_name, 'name': sub_name,'section':sub_section,'teacher_id':teacher_id}
#     response = supabase.table("subjects").insert(data).execute()
#     return response.data
...
def enroll_student_to_subjects(student_id, subject_id):
