...
from src.piplines.face_pipline import predict_attendence
...
from src.components.dialog_attencence_result import attendence_result_dialog
...
def teacher_tab_take_attendence():
    ...
    if not subjects:
        st.warning('You havent created any subjects yet! Please create one to begain!')
        return
